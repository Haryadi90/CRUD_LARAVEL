...
<head>
  ...
  <title>MANAJEMENT TOKO SURYA</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
     ...
     <!--   <a href="../../index3.html" class="nav-link">nana</a> -->
      </li>
      <li class="nav-item d-none d-sm-inline-block">
       <!-- <a href="#" class="nav-link">aaj</a>-->
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">TB SURYA</span>
    </a>
...
-->
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="http://127.0.0.1:8000/pembelians" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pembelian</p>
                  <!--../layout/top-nav.html -->
                </a>
              ...
              <li class="nav-item">
                <a href="http://127.0.0.1:8000/pengeluarans" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pengeluaran</p>
                </a>
              </li>
